package com.triobank.account.exception;
...
public class GlobalExceptionHandler {
     ...
     * Business logic hataları (örn: Product bulunamadı, Account bulunamadı)
     */
     ...
     * Bean validation hataları (@NotBlank, @Size, etc.)
     */
     ...
     * UUID parsing, enum conversion ve diğer argument hataları
     */
    ...
    public ResponseEntity<Map<String, Object>> handleGenericException(
        ...
        // Production'da exception detaylarını logl ayalım ama kullanıcıya göstermeyelim
