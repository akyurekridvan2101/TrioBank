 ...
 * 
 * NOT: Account ve Ledger servislerinden pattern kopyalanmıştır.
 */
@Entity
...
public class OutboxEvent {
     ...
     * Örnekler: "CardIssued", "CardBlocked", "CardActivated"
     */
     ...
     * Örnek: {"cardId": "card-123", "cardType": "DEBIT", "status": "ACTIVE"}
     */
